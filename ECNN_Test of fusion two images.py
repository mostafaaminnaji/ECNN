...
network_feeding_path1= './feed_lytro-03-A.tif'
network_feeding_path2= './feed_lytro-03-B.tif'
...
img1 = Image.open(network_feeding_path1)
img2 = Image.open(network_feeding_path2)
...
test_image1_1=test_image1[:,:,0]
test_image1_2=test_image1[:,:,1]
test_image1_3=test_image1[:,:,2]

test_image2_1=test_image2[:,:,0]
test_image2_2=test_image2[:,:,1]
test_image2_3=test_image2[:,:,2]
...
map1=np.zeros([test_image1.shape[0], test_image1.shape[1]])
map2=np.zeros([test_image1.shape[0], test_image1.shape[1]])
map3=np.zeros([test_image1.shape[0], test_image1.shape[1]])
map4=map3
MAP=np.zeros([test_image1.shape[0], test_image1.shape[1]])
...
for r in tqdm(range(0,test_image1.shape[0] - windowsize_r, stride)):
    for c in range(0,test_image1.shape[1] - windowsize_c, stride):
